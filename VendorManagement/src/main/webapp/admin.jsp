...
<body>
    <label> <input type="checkbox" class="input">
        <div class="toggle">
            <span class="top_line common"></span> <span class="middle-line common"></span> <span
                class="bottom_line common"></span>
        </div>
        <div class="slide">
            <h1>MENU</h1>
            <ul>
                <li><a href="#"><i class="fa fa-tv"></i>Dashboard</a></li>
                <li><a href="#"><i class="fa fa-folder"></i>File Manager</a></li>
                <li><a href="#"><i class="fa fa-heart"></i>Saved</a></li>
                <li><a href="#"><i class="fa fa-cogs"></i>Settings</a></li>
                <li><a href="adminlogin.jsp"><i class="fa fa-right-from-bracket"></i>Log-out</a></li>
            </ul>
        </div>
    </label>
    <div class="table-container">

        <span  > <i class="fa fa-clock mt-3 "  id="current-time">LOGED TIME</i></span>
        <label> <input type="text" class="form-control" id="vendorInput" onkeyup="search()"
        ...
        <table class="table" id="vendorTable">
            ...
            <tbody>
                <c:forEach items="${ent}" var="entites">
                    <tr>
                        <td data-label="Id">${entites.id}</td>
                        <td data-label="Vendor Name">${entites.vendorName}</td>
                        <td data-label="Loaction">${entites.location}</td>
                        ...
                        <td data-label="Webiste">${entites.website}</td>
                        <td data-label="Profile Status">${entites.accountLockStatus}</td>
                        <td data-label="Status">${entites.status}</td>
                        <td><a href="approveStatus/${entites.id}" class="actionBtn" id="approveBtn">Approve</a> <a
                                href="rejectStatus/${entites.id}" class="actionBtn" id="rejectBtn">Reject</a></td>
                    </tr>
                </c:forEach>
