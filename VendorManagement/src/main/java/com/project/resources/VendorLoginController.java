...
public class VendorLoginController {
	...
	@GetMapping(value = "/profileDetail/{email}")
	public List<VendorManagementEntity> profileView(String email) {
		System.out.println("invoking the profileView in vendorloginController");
		return this.service.profileDetails(email);
	}
